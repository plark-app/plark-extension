...
export class WalletItemComponent extends React.PureComponent<any, any> {
    onChangeIt = () => {
...
const mapStateToProps = (store, ownProps) => {
    ...
    if (walletData) {
        ...
        balanceAmount = Wallet.calculateBalance(pwProvider.balance, true);
    }
...
export const WalletItem = connect(mapStateToProps)(WalletItemComponent);